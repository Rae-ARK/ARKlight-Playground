  ...
  suite("Endpoint Discovery", () => {
    ...
    test("throws on 403 from endpoint discovery", async () => {
      ...
      await assert.rejects(
        ...
        (err) => err.message.includes("Copilot endpoint discovery failed: 403")
      );
    });
