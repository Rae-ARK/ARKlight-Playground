...
import { IWorkbenchLayoutService, Parts, Position, FLOATING_PANEL_INNER_MARGIN, FLOATING_PANEL_MARGIN, getFloatingOuterGutterEdges, getFloatingSidebarSiblingToEditorStatus } from "../../services/layout/browser/layoutService.js";
...
let AbstractPaneCompositePart = class extends CompositePart {
  ...
  getFloatingInset() {
    ...
    const bottomMargin = !this.layoutService.isVisible(Parts.STATUSBAR_PART, getWindow(this.element)) && isAtWindowBottom ? margin * 2 : FLOATING_PANEL_INNER_MARGIN;
    const outerGutter = this.getFloatingOuterGutterEdges();
