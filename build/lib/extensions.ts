...
//
// ARKlight note: trimmed to match what survives PRUNE-PLAN.md's batches --
// ipynb, markdown-language-features, markdown-math, mermaid-markdown-features,
// and notebook-renderers were all pruned, but this list still pointed at their
// tsconfig.json files, which made spawnTsgo fail outright (unlike the
// clean-extension-*/compile-extension:* gulp tasks for those same pruned
// extensions, which are silent no-ops against a missing directory).
